...
it("Test command palette functions", function () {
  ...
  cy.get('[data-test="create-calculator-item"] > .justify-between > .flex > span').click();
  ...
  cy.get('[data-test="total-courses-stat"] > .text-2xl').should('have.text', '1');
  cy.get('[data-test="command-palette-btn"]').click();
  cy.get('[data-test="open-calculator-item"]').click();
  cy.get('[data-test="calculator-item"] > .justify-between').should('have.text', ' Test 1 ');
